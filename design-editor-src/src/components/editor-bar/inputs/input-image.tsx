                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="p-3 flex flex-col gap-3">
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="w-full justify-start gap-2 bg-background-secondary hover:bg-background-tertiary text-foreground border-border"
                                disabled={isUploading}
                            >
                            ...
                            <Button
                                ...
                                variant="outline"
                                disabled={isUploading}
                                className="w-full justify-start gap-2 bg-background-secondary text-foreground border-border hover:bg-background-tertiary disabled:opacity-50"
                            >
                                <div className="flex items-center gap-2">
                                    {isUploading ? (
