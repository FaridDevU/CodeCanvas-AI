    ...
    return (
        <div className={`${WIDTH} flex flex-col`}>
            <div className="flex flex-row justify-between items-center px-3 py-2">
                ...
                <Button onClick={closeWindowsTab} variant="ghost" size="icon" className="hover:bg-background-tertiary/20 hover:text-foreground hover:border hover:border-border focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none focus-visible:outline-none active:border-0 w-fit h-fit">
