                ...
                <AlertDialogContent className="max-w-2xl bg-background-onlook/20 p-0 max-h-[80vh] gap-0">
                    <div className="relative flex flex-col">
                        ...
                        <div className="flex flex-col px-6 pb-0 mb-0 flex-1 min-h-0">
                            <div
                                className="flex flex-col items-center justify-center p-8 border border-dashed border-border rounded-lg bg-background-secondary/40 cursor-pointer mb-6"
                                onClick={() => fileInputRef.current?.click()}
                                onDrop={handleDrop}
                                onDragOver={handleDragOver}
                            >
                                <div className="w-10 h-10 flex items-center justify-center rounded-md bg-background-secondary border border-border mb-4">
                                    <svg
