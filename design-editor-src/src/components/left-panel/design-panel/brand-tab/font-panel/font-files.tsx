        ...
        return (
            <div className="space-y-2 flex-1 max-h-[350px] pb-6 overflow-y-auto">
                {fontFiles.map((font, index) => (
                    <div
                        key={index}
                        className="flex flex-col space-y-2 border border-border rounded-lg p-3 bg-background-secondary/40"
                    >
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative">
                                    <select
                                        className="appearance-none bg-background-secondary border border-border rounded-md text-sm p-2 pr-8 text-foreground cursor-pointer hover:bg-background-hover hover:text-accent-foreground hover:border-border-hover"
                                        value={font.weight}
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-9 w-9 border border-border bg-background-secondary rounded-md"
