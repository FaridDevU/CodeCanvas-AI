...
import { ICliAgentService, NullCliAgentService } from '../platform/cliAgent/common/cliAgent.js';
...
registerSingleton(ICliAgentService, NullCliAgentService, InstantiationType.Delayed);
