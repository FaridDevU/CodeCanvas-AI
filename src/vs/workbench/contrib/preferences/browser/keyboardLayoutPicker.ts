...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in CodeCanvas in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open CodeCanvas and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
