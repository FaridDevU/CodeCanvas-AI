...
import { CliModelsContribution } from './cliProviders/cliModelsContribution.js';
	...
	properties: {
		...
		[mcpAccessConfig]: {
			...
			enumDescriptions: [
				...
				nls.localize('chat.mcp.access.registry', "Allows access to MCP servers installed from the registry that CodeCanvas is connected to."),
			...
			policy: {
				...
				localization: {
					...
					enumDescriptions: [
						...
						{
							key: 'chat.mcp.access.registry', value: nls.localize('chat.mcp.access.registry', "Allows access to MCP servers installed from the registry that CodeCanvas is connected to."),
						},
						{
...
registerWorkbenchContribution2(CliModelsContribution.ID, CliModelsContribution, WorkbenchPhase.Eventually);
